...
public class Votes
{
    ...
    /// </summary>
    /// <returns></returns>
    public async Task<GetVotesResponse> GetTicketVotes(Guid ticketId, CancellationToken cancellationToken)
    {
    ...
    /// </summary>
    /// <returns></returns>
    public async Task<CreateVoteResponse> CreateVote(CreateVoteCommand data, CancellationToken cancellationToken)
    {
    ...
    /// </summary>
    /// <returns></returns>
    public async Task<UpdateVoteResponse> UpdateVote(UpdateVoteCommand data, CancellationToken cancellationToken)
    {
